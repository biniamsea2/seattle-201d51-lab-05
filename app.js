...
function multiply(num1, num2) { //eslint-disable-line
  ...
  var message = 'The product of ' + num1+ ' and ' +num2+ ' is ' + answer+ '.';
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var multiplyTotal = multiply(sum3,c)[0];
  return [sum2, multiplyTotal, a + ' and ' + b + ' and '+c+ ' sum to '+ sum2 + '.', 'The product of ' + a+' and '+b+' and ' +c+' is ' +multiplyTotal+'.'];
...
return [arrayTotal, testArray + ' was passed in as an array of numbers, and 9 is their sum.'];
}
